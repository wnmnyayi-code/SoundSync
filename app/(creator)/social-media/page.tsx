...
import { Share2, Facebook, Twitter, Instagram, Youtube, MessageCircle, CheckCircle2, XCircle, Link as LinkIcon } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center space-x-3 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Connect your social accounts and share your music</p>
          </div>
        </div>
        ...
        <Card className="bg-card border-border">
          <CardHeader>
            ...
            <CardDescription>Link your social media accounts for easy sharing and analytics</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-card border-border">
          <CardHeader>
            ...
            <CardDescription>Add your social media profile URLs manually</CardDescription>
          </CardHeader>
        ...
        <Card className="bg-card border-border">
          <CardHeader>
            ...
            <CardDescription>Share SoundSync content directly from social media platforms</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
        ...
        <Card className="bg-card border-border">
          <CardHeader>
            ...
            <CardDescription>Share your music and engage with fans on WhatsApp</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Connect your WhatsApp Business account to share tracks, announce live sessions, and chat with fans.
            </p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• Share tracks and playlists via WhatsApp</li>
                    <li>• Send live session notifications</li>
