...
import { Music, Users, ShoppingBag, TrendingUp, Coins, Radio, Shield, CreditCard, Zap, Award, Globe, DollarSign } from 'lucide-react'
...
export default function Home() {
  const roles = [
    {
      ...
      features: ['Live listening parties', 'Playlist creation', 'Merchandise store', 'SAMBRO registration'],
  ...
  const features = [
    { icon: Shield, title: 'SARS Compliant', description: 'Fully compliant with South African tax regulations' },
    { icon: CreditCard, title: 'Secure Payments', description: 'Stripe integration with VAT included' },
    ...
    { icon: Globe, title: 'SA Only', description: 'Geo-locked to South Africa, ZAR pricing' },
      ...
      <section className="py-20 px-4 bg-card/50">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Built for South African music creators and fans</p>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-muted/20 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="font-semibold text-foreground">SARS (VAT)</span>
                  </div>
                  <span className="text-2xl font-bold text-muted-foreground">R15 (15%)</span>
                </div>
              </div>
